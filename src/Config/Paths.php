...
class Paths
{
    public const ATTRIBUTE_DESCRIPTION_FILE = DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'html5' . DIRECTORY_SEPARATOR . 'html5-attributes.yaml';

    public const ELEMENT_DESCRIPTION_FILE = DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'html5' . DIRECTORY_SEPARATOR . 'html5-elements.yaml';
    ...
    public const HTML_UNIQUE_ATTRIBUTE_TYPES = DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'html5' . DIRECTORY_SEPARATOR . 'html5-unique-attribute-types.yaml';
    ...
    public const PICO_DESCRIPTION_FILE = DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'picocss' . DIRECTORY_SEPARATOR . 'picocss-specification.yaml';
